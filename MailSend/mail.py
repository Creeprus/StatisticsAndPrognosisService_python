...
class MailSender:
    ...
    def send_report_classic_rabbit(self, year, area, plant, prolificy_model, stock_price=170,
        ...
        rabbit.send_message(body=body, exchange='', routing_key=strings.rabbit_mail_queue)

...
class MailSender:
          ...
          <body>
            ...
            <br>
               <p>
                ...
                {prognosis_income.prognose_profit(prolificy=prolificy_model,
                                                  planting_price=planting_price,
                                                  stock_price=stock_price, plant=plant)}
            </p>
          </body>
        </html>
        """
    ...
    def send_report_reverse(self, receiver, year, area, desired_profit, best_plants, stock_planting_price
                            ):
        message = MIMEMultipart("alternative")
        message["Subject"] = "Отчет по урожайности"
        message["From"] = "smtptester193@gmail.com"
            ...
            <br>
               ...
               {prognosis_income_reverse.prognose_profit(list_values[1], prognosis_income_reverse.return_prices(stock_planting_price, f"{list_keys[1]} planting price"),
                ...
                {prognosis_income_reverse.check_profit(list_keys[1], list_values[1], desired_profit,
                                                       planting_price=prognosis_income_reverse.return_prices(stock_planting_price, f"{list_keys[1]} planting price"),
                                                       stock_price=prognosis_income_reverse.return_prices(stock_planting_price, f"{list_keys[1]} stock price"))}
                </p>
            </p>
          </body>
        </html>
